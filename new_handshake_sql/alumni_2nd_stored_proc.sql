...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT DISTINCT
            ...
            CASE 
                WHEN [edu].[Handshake_Name] = 'NONE' THEN '' 
                ELSE [edu].[Handshake_Name] 
            END AS [primary_education:education_level_name],
            ...
            [handshakeDB].[dbo].[fn_ConcatMajors_v2](
                [termf].[STUDENT_CURR_1_MAJOR_NAME],
                [termf].[STUDENT_CURR_1_MAJOR_2_NAME],
                [termf].[STUDENT_CURR_2_MAJOR_1_NAME],
                [termf].[STUDENT_CURR_2_MAJOR_2_NAME]
            ) AS [primary_education:major_names],
            [handshakeDB].[dbo].[fn_ConcatMajors_v2](
                [termf].[STUDENT_CURR_1_MINOR_1_NAME],
                [termf].[STUDENT_CURR_1_MINOR_2_NAME],
                [termf].[STUDENT_CURR_2_MINOR_1_NAME],
                [termf].[STUDENT_CURR_2_MINOR_2_NAME]
            ) AS [primary_education:minor_names],
            ...
            CASE 
                ...
                WHEN [UIN].[RACE_ETH_RPT_DESC] = 'International' AND [UIN].[MULT_RACE_IND] = 'N' AND [UIN].[HISPANIC_ETH_IND] = 'Y' THEN 'Hispanic'
                WHEN [UIN].[RACE_ETH_RPT_DESC] = 'International' AND [UIN].[MULT_RACE_IND] = 'N' AND [UIN].[AIAN_RACE_IND] = 'Y' THEN 'AIAN'
                WHEN [UIN].[RACE_ETH_RPT_DESC] = 'International' AND [UIN].[MULT_RACE_IND] = 'N' AND [UIN].[ASIAN_RACE_IND] = 'Y' THEN 'Asian'
                WHEN [UIN].[RACE_ETH_RPT_DESC] = 'International' AND [UIN].[MULT_RACE_IND] = 'N' AND [UIN].[BLACK_RACE_IND] = 'Y' THEN 'Black/African American'
                WHEN [UIN].[RACE_ETH_RPT_DESC] = 'International' AND [UIN].[MULT_RACE_IND] = 'N' AND [UIN].[NHPI_RACE_IND] = 'Y' THEN 'NHPI'
                WHEN [UIN].[RACE_ETH_RPT_DESC] = 'International' AND [UIN].[MULT_RACE_IND] = 'N' AND [UIN].[WHITE_RACE_IND] = 'Y' THEN 'White'
